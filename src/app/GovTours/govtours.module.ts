...
import { GovtoursRouteModule } from './govtours-route.module';
...
@NgModule({
  ...
  imports: [
    CommonModule, SharedTranslationsModule, HttpClientModule, GovtoursRouteModule,
    MatTableModule,
    MatIconModule,
